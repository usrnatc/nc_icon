...
//         {
//             if (CLI->Inputs.Count) {
//                 APP_CTX.WorkingDir = CLI->Inputs.Head->String;
//             } else {
//                 APP_CTX.WorkingDir = "."_s8;
//             }

//             if (APP_CTX.WorkingDir.Size) {
//                 APP_CTX.WorkingDir = PathAbsoluteDstFromRelativeDstSrc(
//                     MemPool,
//                     APP_CTX.WorkingDir,
//                     GetProcessProperties()->InitialPath
//                 );
...
//         if (IconSizeString.Size) {
//             APP_CTX.IconSize = U32FromStr(IconSizeString);
...
//                 APP_CTX.IconSize != 48 &&
//                 APP_CTX.IconSize != 64 &&
//                 APP_CTX.IconSize != 128 &&
//                 APP_CTX.IconSize != 256
//             ) {
//                 APP_CTX.IconSize = 256;
//             }
//         } else {
...
//         APP_CTX.ShouldSkipRename = CommandLineHasFlag(CLI, "no-rename"_s8);
//         APP_CTX.BeVerbose = (
//             CommandLineHasFlag(CLI, "verbose"_s8) ||
//             CommandLineHasFlag(CLI, "v"_s8)
//         );
...
//         "===================================================\n"
//         "Target Directory: %S\n",
//         PRINT_STR(APP_CTX.WorkingDir)
//     );

//     if (APP_CTX.IsDryRun)
//         PrintOut("Mode: Dry Run (no changes will be made)\n"_s8);

//     if (APP_CTX.ShouldSkipRename)
//         PrintOut("Artwork renaming is DISABLED\n"_s8);

//     PrintOut("---------------------------------------------------\n"_s8);

//     {
//         if (!SystemDirExists(APP_CTX.WorkingDir)) {
//             PrintErr(
//                 "ERROR: Directory \"%S\" does not exist\n",
//                 PRINT_STR(APP_CTX.WorkingDir)
//             );
...
//         ListPush(MemPool, &DirsToProcess, APP_CTX.WorkingDir);
...
//         for (
//             Str8Node* Node = DirsToProcess.Head;
//             Node;
//             Node = Node->Next
//         ) {
//             TempArena Scratch = GetScratch(&MemPool, 1);
//             Str8 CurrentFolder = Node->String;
//             Str8 DesktopINIPath = ArenaPushStrFmt(
//                 Scratch.MemPool,
//                 "%S\\desktop.ini",
//                 PRINT_STR(CurrentFolder)
...
//             for (
//                 FileInfo Info = {};
//                 SystemFileIterNext(Scratch.MemPool, Iter, &Info);
//             ) {
//                 TempArena Scratch2 = GetScratch(&Scratch.MemPool, 1);
//                 Str8 FileName = Info.Name;
//                 Str8 Extension = StrSkipLastDot(FileName);
...
//                     for (
//                         u64 Index = 0; 
//                         Index < ARRAY_COUNT(RenameRules); 
//                         ++Index
//                     ) {
//                         Str8 Pattern = RenameRules[Index].Pattern;
//                         Str8 Replacement = RenameRules[Index].Replacement;
//                         u64 PatternLoc = StrFindSubStr(
//                             FileName,
//                             Pattern,
//                             0,
...
//                     if (
//                         StrMatch(NameNoExt, "folder"_s8, STR_MATCH_ALL_CASES) ||
//                         StrMatch(NameNoExt, "poster"_s8, STR_MATCH_ALL_CASES)
//                     ) {
//                         if (
//                             StrMatch(Extension, "jpg"_s8, STR_MATCH_ALL_CASES) ||
//                             StrMatch(Extension, "jepg"_s8, STR_MATCH_ALL_CASES) ||
//                             StrMatch(Extension, "png"_s8, STR_MATCH_ALL_CASES)
//                         ) {
//                             FoundPosterPath = ArenaPushStrCpy(
//                                 Scratch.MemPool,
//                                 CurrentFullPath
//                             );
//                         }
...
//                 if (APP_CTX.IsDryRun) {
//                     PrintOut(
//                         "\t[DRY RUN] Would create icon from: %S\n",
//                         PRINT_STR(FoundPosterPath)
//                     );
//                     ++SuccessCount;
//                 } else {
//                     b32 IconSuccess = FALSE;
//                     Str8 FileData = ReadFileContents(
//                         Scratch.MemPool,
//                         FoundPosterPath
//                     );
...
//                         if (Pixels) {
//                             int TargetSize = (int) APP_CTX.IconSize;
//                             f32 Ratio = (f32) Width / (f32) Height;
//                             int NewWidth = TargetSize;
//                             int NewHeight = TargetSize;
...
//                             u8* ResizedPixels = ArenaPushArrayZero(
//                                 Scratch.MemPool,
//                                 u8,
//                                 NewWidth * NewHeight * 4
//                             );
//                             u8* BackgroundPixels = ArenaPushArrayZero(
//                                 Scratch.MemPool,
//                                 u8,
//                                 TargetSize * TargetSize * 4
//                             );
...
//                     } else {
//                         LogError(
//                             "failed to open poster image file \"%S\"", 
//                             PRINT_STR(FoundPosterPath)
//                         );
//                     }
...
//                         if (WriteFileContents(DesktopINIPath, INIContent)) {
//                             Str16 WideINIPath = Str16FromStr8(
//                                 Scratch.MemPool,
//                                 DesktopINIPath
//                             );
//                             Str16 WideFolderPath = Str16FromStr8(
//                                 Scratch.MemPool,
//                                 CurrentFolder
//                             );

//                             SetFileAttributesW(
//                                 (WCHAR*) WideINIPath.Str,
//                                 FILE_ATTRIBUTE_SYSTEM | FILE_ATTRIBUTE_HIDDEN
//                             );
//                             SetFileAttributesW(
//                                 (WCHAR*) WideFolderPath.Str,
...
//         if (!APP_CTX.IsDryRun && SuccessCount > 0) {
//             SHChangeNotify(
//                 SHCNE_ASSOCCHANGED,
//                 SHCNF_IDLIST,
//                 NULL,
