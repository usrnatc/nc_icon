...
typedef struct {
    ...
    Rotation__ rotation;		/* current rotation of associated crtc */
...
Rotation__ XRRConfigRotations(XRRScreenConfiguration *config, Rotation__ *current_rotation);
...
Rotation__ XRRRotations(Display *dpy, int screen, Rotation__ *current_rotation);
